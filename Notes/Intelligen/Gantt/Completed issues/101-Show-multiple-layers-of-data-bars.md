...
bars: [ [ {bar1}, {bar2}, {bar3} ], [ {bar1}, {bar2}, {bar3} ] , Ξ²β‚¬Β¦ ]  
|____actual________| |_____baseLine(n)___|, |___bL(n-1)___|  
Index 0 is the actual and all the othes are baseline (n, n-1, n-2, Ξ²β‚¬Β¦ 1)  
...
rowIndex  
barLayerIndex (actual = 0, baseline(n) = 1, Ξ²β‚¬Β¦)  
barIndex  
globalBarIndex
...
Co = 1  
C1 = 0.8 * 1 + 0.2*B  
C2 = 0.8*(0.8 * 1 + 0.2*B) + 0.2*B = Ξ²β‚¬Β¦

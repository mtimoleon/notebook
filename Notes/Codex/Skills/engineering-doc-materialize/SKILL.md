...
- If I do not specify, use dry-run.
...
After I provide the path, tag, and mode:
...
In dry-run mode:
- do not write files
- report planned creates/updates/skips
- include note paths and short rationale
...
After dry-run or write, report only:
